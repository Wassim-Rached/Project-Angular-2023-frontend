...
const routes: Routes = [
  ...
  {
    path: "activities", title: "Activities", component: ActivitiesPageComponent, children: [
      { path: "", title: "activity list", component: ActivityListComponent },
      { path: "/:activityId", title: "activity Details", component: ActivityOverViewComponent }
